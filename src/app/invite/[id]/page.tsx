                        ...
                        <div className="relative z-10">
                            ...
                            <div className="mb-10">
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    <button
                                        ...
                                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 ${showQR ? 'bg-purple-600' : 'bg-gray-600'
                                            }`}
                                    >
                                        <span
                            ...
                            <div className="text-center mb-10">
                                ...
                                <div className="space-y-2 text-gray-400 font-[var(--font-space-mono)] tracking-wider text-sm">
                                    ...
                                    <p>VENUE: Common Study FOC NSBM</p>
